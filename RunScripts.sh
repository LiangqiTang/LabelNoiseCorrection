...
python train.py --Mixup 'Static' --BootBeta 'Hard' --experiment-name 'M-DYR-H-BMM' --epochs 100 --M 30 80 --noise-level 0 --reg-term 1.0 --dataset TinyImageNet --batch-size 256 --lr 0.001
